...
<FORM method="POST">
    <table style="margin: auto">
        ...
        <tr>
            ...
            <td><input id="id_password" name="password" type="password" placeholder="Пароль" size="35" maxlength="35"
                       required oninput='check_pass();'/></td>
        </tr>
        <tr>
            <td style="text-align: left"><fmt:message key="registration.confirm"/>:</td>
            <td><input id="id_confirm" name="password" type="password" placeholder="Подтверждение пароля" size="35"
                       maxlength="35" required oninput='check_pass();'/></td>
        </tr>
        <tr>
            <td><input id="id_btnReg" type="submit" class="button" name="btnReg" value=
            <fmt:message key="registration.reg"/>/></td>
        </tr>
    </table>
</FORM>
