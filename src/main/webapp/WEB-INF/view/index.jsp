    ...
    <FORM method="POST">
        <table style="margin: auto">
            <tr>
                ...
                <td><input name="email" type="email" size="35" placeholder="E-mail" autocomplete="on" autofocus
                           required/></td>
            </tr>
            <tr>
                <td style="text-align: left"><fmt:message key="registration.password"/>:</td>
                <td><input name="password" type="password" placeholder="<fmt:message key="registration.password"/>"
                           size="35" maxlength="35" required/></td>
            </tr>
            <tr>
                <td><input type="submit" class="button" name="btnLogin" value=
                    <fmt:message key="menu.enter"/>/></td>
            </tr>
        </table>
    </FORM>
