...
public class CommandCloseInvoice implements Command {

    private static final Logger LOGGER = Logger.getLogger(CommandCloseInvoice.class);
    private InvoiceService serv;

    public CommandCloseInvoice(InvoiceService serv) {
        this.serv = serv;
    }
