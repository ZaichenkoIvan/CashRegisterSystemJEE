...
public class CommandOpenProductMngPage implements Command {

    private static final Logger LOGGER = Logger.getLogger(CommandOpenProductMngPage.class);
    private ProductService serv;

    public CommandOpenProductMngPage(ProductService serv) {
        this.serv = serv;
    }
