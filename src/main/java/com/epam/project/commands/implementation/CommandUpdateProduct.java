...
public class CommandUpdateProduct implements Command {

    private static final Logger LOGGER = Logger.getLogger(CommandUpdateProduct.class);
    private ProductService serv;

    public CommandUpdateProduct(ProductService serv) {
        this.serv = serv;
    }
