...
public class CommandCreateInvoice implements Command {

    private static final Logger LOGGER = Logger.getLogger(CommandCreateInvoice.class);
    private InvoiceService invoiceServ;

    public CommandCreateInvoice(InvoiceService invoiceServ) {
