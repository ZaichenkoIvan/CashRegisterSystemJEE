...
public class GoodsDAO implements IGoodsDAO<Goods> {
    ...
    private GoodsDAO(PoolConnection poolConnection) {
        this.poolConnection = poolConnection;
    }

    public static IGoodsDAO<Goods> getInstance(PoolConnection poolConnection) {
        if (instance == null) {
            instance = new GoodsDAO(poolConnection);
        }
        return instance;
    }
