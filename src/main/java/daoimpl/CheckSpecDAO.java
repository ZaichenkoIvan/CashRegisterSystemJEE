...
public class CheckSpecDAO implements ICheckSpecDAO<Checkspec> {
	...
	private CheckSpecDAO(PoolConnection poolConnection) {
		this.poolConnection = poolConnection;
	}
	
	public static ICheckSpecDAO<Checkspec> getInstance(PoolConnection poolConnection) {
		if (instance == null) {
			instance = new CheckSpecDAO(poolConnection);
		}
		return instance;		
	}
